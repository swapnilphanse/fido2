 ...
 */
package fido.capstone.webauthn.db.tables;
...
import fido.capstone.webauthn.db.Indexes;
import fido.capstone.webauthn.db.Keys;
import fido.capstone.webauthn.db.Webauthn;
...
public class AppUser extends TableImpl<AppUserRecord> {
  ...
  public final TableField<AppUserRecord, String> NAME = createField("name",
	      org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");
